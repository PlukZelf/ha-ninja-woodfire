...
The integration is intended to run fully locally inside Home Assistant. It will communicate with the Ninja Woodfire device over Bluetooth Low Energy and translate device state into Home Assistant entities.
